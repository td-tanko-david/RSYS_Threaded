...
QT_MOC_LITERAL(4, 25, 9) // "init_send"
    ...
    "MyLineEdit\0send_msg\0\0msg\0init_send"
};
...
void MyLineEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyLineEdit::send_msg)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyLineEdit::send_msg(QString _t1)
{
