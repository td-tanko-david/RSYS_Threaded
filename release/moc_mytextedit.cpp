...
QT_MOC_LITERAL(4, 25, 9) // "init_send"

    },
    "MyTextEdit\0send_msg\0\0msg\0init_send"
};
...
void MyTextEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (MyTextEdit::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyTextEdit::send_msg)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyTextEdit::send_msg(QString _t1)
{
