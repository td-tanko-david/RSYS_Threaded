...
QT_MOC_LITERAL(1, 9, 11), // "add_message"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 3) // "msg"

    },
    "Receiver\0add_message\0\0msg"
};
...
void Receiver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->add_message((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Receiver::add_message)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Receiver::add_message(QString _t1)
{
